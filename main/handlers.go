...
func home(w http.ResponseWriter, r *http.Request) {
	...
	files := []string{
		"C:\\Users\\VovaGlh\\GolandProjects\\awesomeProject1\\Gin_project\\ui\\html\\home.page.tmpl.xhtml",
		"Gin_project/ui/html/base.layout.tmpl.xhtml",
		"Gin_project/ui/html/footer.partial.tmpl.xhtml",
	}
